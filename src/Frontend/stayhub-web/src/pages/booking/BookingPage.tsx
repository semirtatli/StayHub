...
export function BookingPage() {
  ...
  const totalPrice = selectedRoom ? selectedRoom.pricePerNight * Math.max(nights, 0) : 0;
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      {hotel && (
        <p className="mt-1 text-gray-500">{hotel.name} — {hotel.city}, {hotel.country}</p>
      )}
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <span className="ml-2 text-sm text-gray-500">({room.capacity} guests)</span>
                        </div>
                      </div>
          ...
          <div className="sticky top-24 rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
            ...
            <div className="mt-4 space-y-2 text-sm text-gray-600">
              ...
              {selectedRoom && nights > 0 && (
                <p>Rate: {formatCurrency(selectedRoom.pricePerNight)} × {nights}</p>
              )}
            </div>
