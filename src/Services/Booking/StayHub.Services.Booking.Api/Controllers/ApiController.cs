...
/// All Booking API controllers inherit from this for consistent error handling.
/// </summary>
[ApiController]
...
public abstract class ApiController : ControllerBase
{
    ...
    private IActionResult HandleFailure(Result result)
    {
        ...
        var statusCode = result.Error.Code switch
        {
            ...
            var code when code.Contains("Forbidden") || code.Contains("NotGuest") || code.Contains("NotHotelOwner") => StatusCodes.Status403Forbidden,
