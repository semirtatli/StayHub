...
/// <summary>
/// Validates AddRoomCommand before it reaches the handler.
///
/// Rules:
/// - HotelId: required
...
/// - MaxOccupancy: at least 1, max 20
/// - BasePrice: positive
/// - Currency: required, exactly 3 chars (ISO 4217)
/// - TotalInventory: at least 1
/// - SizeInSquareMeters: positive if provided
/// - Amenities/PhotoUrls: individual items not empty
/// </summary>
