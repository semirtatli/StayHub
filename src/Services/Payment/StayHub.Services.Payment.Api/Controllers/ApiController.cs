...
/// All Payment API controllers inherit from this for consistent error handling.
/// </summary>
[ApiController]
...
public abstract class ApiController : ControllerBase
{
    ...
    private IActionResult HandleFailure(Result result)
    {
        ...
        var statusCode = result.Error.Code switch
        {
            ...
            var code when code.Contains("Unauthorized") || code.Contains("InvalidWebhookSignature") => StatusCodes.Status401Unauthorized,
            var code when code.Contains("Forbidden") || code.Contains("NotOwner") => StatusCodes.Status403Forbidden,
