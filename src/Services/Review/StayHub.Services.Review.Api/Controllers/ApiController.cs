...
/// All Review API controllers inherit from this for consistent error handling.
/// </summary>
[ApiController]
...
public abstract class ApiController : ControllerBase
{
    ...
    private IActionResult HandleFailure(Result result)
    {
        ...
        var statusCode = result.Error.Code switch
        {
            ...
            var code when code.Contains("Duplicate") || code.Contains("Conflict") || code.Contains("AlreadyReviewed") => StatusCodes.Status409Conflict,
            var code when code.Contains("Unauthorized") => StatusCodes.Status401Unauthorized,
            var code when code.Contains("Forbidden") || code.Contains("NotOwner") || code.Contains("NotAuthor") || code.Contains("NotHotelOwner") => StatusCodes.Status403Forbidden,
